...
| `YAM_bimanual_molmoact` | `yam_bimanual.usd` | 2 x 6 | as `YAM_bimanual` | MolmoAct2-like top camera 0.30 m ahead / 1.26 m above the arm bases looking straight down (15 mm), wrist cameras at YAMLab's 25 deg calibration (`wrist_camera_pose`); for `--model_type openpi_yam` |
