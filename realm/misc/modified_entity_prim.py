...
class EntityPrim(XFormPrim):
    ...
    def _load_state(self, state):
        ...
        elif self.n_joints > 0 and "joint_pos" in state:
            # TODO: (martin) added the second check due to errors whe nswapping object in VSB_NOBJ
            # it is not clear why n_joints > 0 in the first plac for these cases
